...
public class immobile {
    ...
    // Costruttore completo tranne id e dataCreazione
    public immobile(Agente agente, posizione posizione, String titolo, String descrizione,
                    BigDecimal prezzo, Integer dimensioni, Integer numeroStanze,
                    Integer piano, Boolean ascensore, String classeEnergetica, String categoria) {
        this.agente = agente;
        ...
        this.piano = piano;
        this.ascensore = ascensore != null ? ascensore : false;
    ...
    public Integer getDimensioni() { return dimensioni; }
    public void setDimensioni(Integer dimensioni) { this.dimensioni = dimensioni; }
